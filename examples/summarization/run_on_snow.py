...
def run_exp(exp_dict, savedir, args):
    ...
    if exp_name.startswith("marlhf"):
        ...
        print("RLHF")
        accelerate_launch("examples/summarization/rl_training.py", exp_dict, args)
    elif exp_name.startswith("dpo"):
        print("DPO")
        accelerate_launch("examples/summarization/dpo_training.py", exp_dict, args)
    elif exp_name.startswith("cpo"):
        print("CPO")
        accelerate_launch("examples/summarization/cpo_training_base.py", exp_dict, args)
...
def accelerate_launch(training_file, training_args_dict, args):
    ...
    if args.accelerate_config is not None and args.accelerate_config != "None":
        ...
        training_cmd_args.extend(["--main_process_port", "0"])
    elif args.gpus > 1:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-sb",
        "--savedir_base",
        default="/home/lijiang/trl/unused_results",
